function signoZodiaco(fechaNacimiento:Date)
{
...
let fecha: Date = new Date(2020, 0, 18);
...
function guessContinent(pais: string)
{
    const Europa: string[] = ["España", "Portugal", "Francia", "Alemania", "Italia"];
    const AmericaDelSur: string[] = ["Argentina", "Brasil", "Chile", "Uruguay", "Colombia"];
    const Asia: string[] =["China", "Japon", "Corea del Sur ", "India", "Iran", ];
    const Oceania: string[] = ["Australia", "Nueva Zelanda", "Tonga", "Samoa", "Fiyi"];
    const AmericaDelNorte: string[] =["Estados Unidos", "Canada", "Haiti", "Panama", "Republica Dominicada"];
    const Africa: string[] = ["Sudafrica", "Nigeria", "Egipto", "Marruecos", "Ruanda"];
